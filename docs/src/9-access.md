...
> COTTAGE_IDENTITY=.cottage/prod-server.key ctg decrypt prod-secret.yml
> cat prod-secret.yml
> ```
>
> ```stdout
...
> rm dev-secret.yml
> COTTAGE_IDENTITY=.cottage/prod-server.key ctg decrypt dev-secret.yml
> ```
>
> ```stderr
> Error: No matching keys found
