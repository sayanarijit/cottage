...
- [Scenarios: Initializing cottage](2-init.md)
- [Scenarios: Setting up Keys](3-keys.md)
- [Scenarios: Encrypting Secrets](4-encrypt.md)
- [Scenarios: Syncing with Git](5-git.md)
- [Scenarios: Adding Recipient and Decrypting](6-recipient-decrypt.md)
