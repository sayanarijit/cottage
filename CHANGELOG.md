...
## [0.7.3](https://github.com/sayanarijit/cottage/compare/v0.7.2...v0.7.3) - 2026-09-25

### Added

- *(cli)* Add `ctg cat` command to read and pipe secrets via stdin

### Other

- Update copyright year and owner in LICENSE-APACHE
- *(docs)* fix docs for ctg run and ctgx
- *(docs)* update .gitattributes docs
- *(docs)* add vim/nvim demo
- *(doc)* add more plugins

## [0.7.2](https://github.com/sayanarijit/cottage/compare/v0.7.1...v0.7.2) - 2026-08-27

### Added

- *(identitystr)* Allow passing the private key directly
